import useTotalGastoPorcentaje from "../hooks/useTotalGastoPorcentaje.tsx";
...
const PorcentanjeGastos = () => {
  ...
  return (<>
    <div className={ "m-auto w-1/2 flex flex-row align-middle justify-around" }>
      ...
      <div className={ "bg-cyan-950 text-amber-50 font-bold px-4 py-1 h-8 my-2" }>{ totalEgresosPorcentaje?.toFixed(2) } %</div>
    </div>
  </>);
}
